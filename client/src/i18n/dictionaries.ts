export const pt = {
  ...
  universities: {
    ...
    description: "Nascemos na Paraíba e hoje conectamos estudantes de universidades de norte a sul do Brasil a mentores no Brasil e no exterior. Gire o globo e escolha uma região para ver quem já faz parte.",
    universitiesLabel: "universidades",
    countriesLabel: "países",
    globeDescription: "Globo interativo com as regiões das universidades participantes e dos mentores. Arraste para girar e escolha uma região para ver quem está lá.",
    hint: "Arraste para girar",
    orbit: "DA UNIVERSIDADE AO MERCADO · MENTORIA · COMUNIDADE · MOMENTO · ",
    regionAria: "Ver quem está em",
    regions: {
      pb: "Paraíba",
      pe: "Pernambuco",
      ba: "Bahia",
    ...
    mentors: [
      { name: "CEFET-MG", city: "belo-horizonte", url: "https://www.cefetmg.br" },
      { name: "Insper", city: "sao-paulo", url: "https://www.insper.edu.br" },
    ...
    items: [
      { name: "UFPB", city: "joao-pessoa", url: "https://www.ufpb.br" },
      { name: "UFCG", city: "campina-grande", url: "https://www.ufcg.edu.br" },
      { name: "UEPB", city: "campina-grande", url: "https://www.uepb.edu.br" },
      { name: "UFG", city: "goiania", url: "https://www.ufg.br" },
      { name: "UFPE", city: "recife", url: "https://www.ufpe.br" },
      { name: "UFBA", city: "salvador", url: "https://ufba.br" },
      { name: "USP", city: "sao-paulo", url: "https://www.usp.br" },
      { name: "UNICAMP", city: "campinas", url: "https://www.unicamp.br" },
      { name: "UNIPÊ", city: "joao-pessoa", url: "https://www.unipe.edu.br" },
    ],
  },
  links: {
...
export const en = {
  ...
  universities: {
    ...
    description: "We were born in Paraíba and today we connect students from universities across Brazil with mentors in Brazil and abroad. Spin the globe and pick a region to see who is already part of it.",
    universitiesLabel: "universities",
    countriesLabel: "countries",
    globeDescription: "Interactive globe with the regions of participating universities and mentors. Drag to spin it and pick a region to see who is there.",
    hint: "Drag to spin",
    orbit: "FROM CAMPUS TO CAREER · MENTORSHIP · COMMUNITY · MOMENTO · ",
    regionAria: "See who is in",
    regions: {
      pb: "Paraíba",
      pe: "Pernambuco",
      ba: "Bahia",
