export const pt = {
  ...
  universities: {
    ...
    description: "Nascemos na Paraíba e hoje conectamos estudantes de universidades de norte a sul do Brasil. Gire o globo e escolha uma região para ver quem já faz parte.",
    universitiesLabel: "universidades",
    regionsLabel: "estados",
    globeDescription: "Globo interativo com as regiões das universidades participantes. Arraste para girar e escolha uma região para ver as universidades.",
    hint: "Arraste para girar",
    orbit: "DA UNIVERSIDADE AO MERCADO · MENTORIA · COMUNIDADE · MOMENTO · ",
    regionAria: "Ver universidades em",
    items: [
...
export const en = {
  ...
  universities: {
    ...
    description: "We were born in Paraíba and today we connect students from universities across Brazil. Spin the globe and pick a region to see who is already part of it.",
    universitiesLabel: "universities",
    regionsLabel: "states",
    globeDescription: "Interactive globe with the regions of participating universities. Drag to spin it and pick a region to see its universities.",
    hint: "Drag to spin",
    orbit: "FROM CAMPUS TO CAREER · MENTORSHIP · COMMUNITY · MOMENTO · ",
    regionAria: "See universities in",
    items: [
      { name: "UFPB", city: "joao-pessoa", url: "https://www.ufpb.br" },
      { name: "UFCG", city: "campina-grande", url: "https://www.ufcg.edu.br" },
      { name: "UEPB", city: "campina-grande", url: "https://www.uepb.edu.br" },
